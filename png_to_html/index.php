...
<body>
	...
	<header class="align">
		<div id="header">
			<div id="logo">
				<ul>
					<li><img src="img/logo@2x.png"></li>
					<li id="process"><img src="img/process.png"></li>
    ...
    <section class="align">
        <!-- container -->        
            <container >
                <div class="container">
                    <ul>
                        <li class="white">THINK SMARTER.</li>
                        <li class="white">EAT HEALTHIER.</li>
                        <li class="white">MOVE BETTER.</li>
                        <li class="white"><button>I WANT TO START TODAY!</button></li>
                        <li class="white">MOVE BETTER.</li>
                    </ul>
                    <div id="video">
    	...
    	<!-- page -->    	
    	   ...
    	   <div id="dots">
    			...
    			<div id="circle">
    				<div id="circle-navy">THINK</div>
    				<div id="circle-green">EAT</div>
    				<div id="circle-orange">MOVE</div>
    			</div>
    		</div>
    	<!-- portfolio -->
    		<div class="portfolio" >
            ...
            <div class="banner-3">
                ...
                <div>
                    ...
                    <div class="banner-3-right">
                        ...
                        <div class="banner-3-right">
                            <img id="banner-3-right-img" src="img/btn-access.png">
                        </div>
                    </div>
                </div>  
    		</div>		
	...
	<footer class="align">
        ...
        <div id="fill">
            <div id="fill-navy"></div>
            <div id="fill-green"></div>
            <div id="fill-orange"></div>
        </div>
    </footer>
</body>
</html>